  ...
  async function handleEditExisting(idx: number) {
    ...
    try {
      ...
      setEditingPage({
        ...
        id: existing.id,
        values: mergedValues,
        autogenerated_content: autoContent,
      });
    } catch (err) {
      console.error(err);
                      ...
                      <>
                        ...
                        {editingPage && (
                          <div className="mt-6">
                            <CreatePageForm
                              selectedWorld={world}
                              selectedConcept={concepts?.find((c: any) => c.id === editingPage.concept_id)}
                              token={token}
                              ...
                              onSubmit={async (payload) => {
                                ...
                                await updatePage(
                                  ...
                                  {
                                    ...payload,
                                    autogenerated_content: editingPage.autogenerated_content,
                            ...
                            />
                            {editingPage.autogenerated_content && (
                              <div className="bg-yellow-200/20 border-l-4 border-yellow-500 p-4 rounded mt-4">
                                <div className="prose prose-invert" dangerouslySetInnerHTML={{ __html: editingPage.autogenerated_content }} />
                              </div>
                            )}
